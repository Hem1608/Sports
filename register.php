...
<head>
    ...
    <title>Registration | Sportsware</title>
...
<body>
    ...
    <section id="title" class="alizarin">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <br>
                    <h2>Registration</h2>
                    <p>Creating an account makes you move through the process faster and view,track our orders in your account!!</p>
                </div>
                <div class="col-sm-6">
        ...
        <form class="center" role="form" method="POST" action="#">
            <fieldset class="registration-form col-lg-7">
                ...
                <div class="form-group">
                    <input type="tel"  name="cont" placeholder="Contact number*" class="form-control">
                </div>
                <hr>
                <h3>Login information</h3>
                <div class="form-group">
                    <input type="text"  name="em" placeholder="E-mail*" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="submit" value="Register" class="btn btn-danger"  name="reg">                        <input type="reset" value="reset" class="btn btn-danger">
...
$em=$_POST["em"];
$pwd=$_POST["password"];
$sql= "INSERT INTO ats (fname,lname,cont,email,pwd)VALUES ('$fname','$lname','$cont','$em','$pwd')";

if ($conn->query($sql) === TRUE) {
   
   echo "Successfully registered!! </br> Please login!!";
    session_start();
            ...
            <div class="row">
                <div class="col-md-5 col-sm-6">
                    ...
                    <p>Athens Sports Wear is a well established sports wear manufacturing company, based in Chennai, India. The company is a recognized Manufacturer, Supplier and Exporter of Sportswear all over India. 
                        Highly acknowledged by the clients in terms of quality, Our products are exported in the markets of USA,Russia and Dubai.</p>                    </div><!--/.col-md-3-->
