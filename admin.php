...
if ($result->num_rows > 0) {
    ...
    <section class="container">
        <form action="add.php" method="post" enctype="multipart/form-data" name="addroom" role="form">
                        <fieldset class="registration-form col-lg-7">
                            
                            
                            <div class="form-group">
                                <input type="text" name="name" class="form-control" placeholder="Name of the image"></br>
                            </div>
                            <div class="form-group">
            <input type="text" name="category" class="form-control" placeholder="Category of the image"></br>
                            </div>
            <div class="form-group">
         
                <input type="file"  value ="upload" name="image" placeholder="select image" class="ed"><br/>
            </div>
          
            <input type="submit" class="btn btn-danger" value="ADD" name="action">
